...
func (in *CodeEditorStatus) DeepCopyInto(out *CodeEditorStatus) {
	*out = *in
	...
	if in.ExternalVolumeStatuses != nil {
		in, out := &in.ExternalVolumeStatuses, &out.ExternalVolumeStatuses
		*out = make([]ExternalVolumeStatus, len(*in))
		copy(*out, *in)
	}
...
func (in *OwnedDeploymentStatus) DeepCopy() *OwnedDeploymentStatus {
	if in == nil {
		return nil
	}
	out := new(OwnedDeploymentStatus)
	in.DeepCopyInto(out)
	return out
}
