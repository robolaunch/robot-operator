...
func (r *NotebookReconciler) reconcileGetTargetRobot(ctx context.Context, instance *robotv1alpha1.Notebook) (*robotv1alpha1.Robot, error) {
...
func (r *NotebookReconciler) reconcileGetTargetRobotVDI(ctx context.Context, instance *robotv1alpha1.Notebook) (*robotv1alpha1.RobotVDI, error) {
...
func (r *NotebookReconciler) reconcileCheckNode(ctx context.Context, instance *robotv1alpha1.Robot) (*corev1.Node, error) {
